...
const AboutPage = () => {
  return (
    <div className="px-10 bg-blue-50 flex-grow flex flex-col items-center justify-center space-y-7 pt-12 pb-0">
      <h1 className="font-extrabold text-4xl md:text-5xl tracking-tighter text-gray-900 max-w-sm text-center">
        What is
        <br />
        Link Room?
      </h1>
      <p className="font-light text-sm max-w-md text-gray-700 text-center">
